...
#define  USB_CFG_VENDOR_ID  0x66, 0x66  /* Prototype product Vendor ID */
 ...
 */
#define USB_CFG_DEVICE_ID   0x04, 0x00  /* Prototype product Product ID */
 ...
 */
#define USB_CFG_VENDOR_NAME     'u', 'p', '.', 'n', 'l', '.', 'e', 'u', '.', 'o', 'r', 'g'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     't', 'i', 'n', 'y', 's', 'c', 't'
